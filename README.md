...
## 支持功能
- [X] 支持常用账号密码，增加错误账号拦截，让蜜罐表现更真实
- [X] 支持shell命令随机延时，避免直接回应，让蜜罐表现更真实
- [X] 支持LLM，让大模型自动回应shell命令，让蜜罐表现更真实
...
### release-v1.2.0（2026-09-20）
- 完整实现Redis、MySQL、PostgreSQL登录协议，增加捕获账号密码功能
- 增加AI仿真命令，使蜜罐更真实
- 优化UI
